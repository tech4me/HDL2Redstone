...
std::vector<std::unique_ptr<Component>>& ModuleNetlist::getComponents() { return Components; }

std::vector<std::unique_ptr<Connection>>& ModuleNetlist::getConnections() { return Connections; }
