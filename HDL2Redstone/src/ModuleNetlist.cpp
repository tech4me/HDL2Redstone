...
std::vector<std::unique_ptr<Component>>* ModuleNetlist::getComponentsPtr() { return &Components; }
std::vector<std::unique_ptr<Connection>>* ModuleNetlist::getConnectionsPtr() { return &Connections; }
